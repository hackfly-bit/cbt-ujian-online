@extends('layouts.vertical', ['page_title' => 'Master Kategori', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-tambah-kategori">
                            <i class="ri-add-line me-1"></i> Tambah Kategori
                        </button>
                    </div>
                    <div class="card-body">
                        <table id="kategori-datatable" class="table table-striped dt-responsive nowrap w-100">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
        ...
        <div class="modal fade" id="modal-tambah-kategori" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="form-tambah-kategori" action="{{ route('kategori.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" id="btn-simpan-kategori">
        ...
        <!-- Modal Edit Kategori -->
        <div class="modal fade" id="modal-edit-kategori" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form id="form-edit-kategori" method="POST">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                            <button type="submit" class="btn btn-primary" id="btn-update-kategori">
                                <span class="spinner-border spinner-border-sm d-none me-2" role="status"></span>
                                Update
                            </button>
                        </div>
...
@section('script')
    @vite(['resources/js/main/kategori.js'])
@endsection
