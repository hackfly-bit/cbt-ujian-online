...
@section('title', 'الاختبار المكتمل')
...
@section('content')
    <div class="completion-container">
        ...
        <div class="completion-card">
            ...
            <h1 class="completion-title mt-3">تم إكمال الاختبار بنجاح!</h1>
            <p class="completion-subtitle">شكراً لإكمالك الاختبار بشكل جيد</p>

            <!-- Overall Score -->
            @if (isset($examSummary))
                <div class="score-highlight">
                    <div class="score-number">{{ $examSummary['total_score'] }}%</div>
                    <div class="score-label">الدرجة الإجمالية</div>
                </div>
            @endif
        </div>
        ...
        @if (isset($examSummary))
            <div class="exam-info">
                <div class="d-flex align-items-center mb-3">
                    <i class="ri-survey-line ms-2 fs-3"></i>
                    <h3 class="mb-0">معلومات الاختبار</h3>
                </div>
                ...
                <div class="info-row">
                    <span class="info-label">اسم المشارك:</span>
                ...
                <div class="info-row">
                    <span class="info-label">إجمالي الأقسام:</span>
                    <span class="info-value">{{ $examSummary['total_sections'] }} قسم</span>
                </div>
                <div class="info-row">
                    <span class="info-label">إجمالي الأسئلة:</span>
                    <span class="info-value">{{ $examSummary['total_questions'] }} سؤال</span>
                </div>
                <div class="info-row">
                    <span class="info-label">الأسئلة المجابة:</span>
                    <span class="info-value">{{ $examSummary['total_answered'] }} سؤال
                        ({{ $examSummary['completion_percentage'] }}%)</span>
                </div>
                <div class="info-row">
                    <span class="info-label">الإجابات الصحيحة:</span>
                    <span class="info-value">{{ $examSummary['total_correct'] }} إجابة</span>
                </div>
                <div class="info-row">
                    <span class="info-label">الإجابات الخاطئة:</span>
                    <span class="info-value">{{ $examSummary['total_incorrect'] }} إجابة</span>
                </div>
                <div class="info-row">
                    <span class="info-label">مدة الإكمال:</span>
                    <span class="info-value">{{ $examSummary['exam_duration_minutes'] }} دقيقة</span>
                </div>
            </div>
            ...
            <div class="completion-time">
                <div class="d-flex align-items-center mb-3">
                    <i class="ri-time-line ms-2 fs-4"></i>
                    <h5 class="mb-0">وقت الإكمال:</h5>
                </div>
                <div class="text-base">
                    البداية: {{ $examSummary['exam_start_time']->format('d/m/Y H:i:s') }} | النهاية:
            ...
            @if (isset($examSummary['section_results']) && count($examSummary['section_results']) > 0)
                <div class="section-results">
                    <div class="d-flex align-items-center mb-3">
                        <i class="ri-bar-chart-line ms-2 fs-3"></i>
                        <h3 class="mb-0">نتائج كل قسم</h3>
                    </div>
                        ...
                        <div class="section-card">
                            ...
                            <div class="section-stats">
                                ...
                                <div class="stat-item">
                                    ...
                                    <div class="stat-label">الاكتمال</div>
                                </div>
                            </div>
                        </div>
                    @endforeach
        ...
        @else
            ...
            <div class="exam-info">
                <div class="d-flex align-items-center mb-3">
                    <i class="ri-checkbox-circle-line ms-2 fs-3"></i>
                    <h3 class="mb-0">تم إكمال الاختبار</h3>
                </div>
                <p style="text-align: center; color: #666; font-size: 16px;">
                    {{ $message ?? 'تم إكمال الاختبار. شكراً لمشاركتك.' }}
                </p>
            </div>
        @endif
        ...
        <div class="action-buttons">
            ...
            <button onclick="window.print()" class="btn btn-secondary">طباعة النتائج</button>
        </div>
    </div>
@endsection
