    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div id="custom-filters-draf" class="mb-3">
                    <select id="filter-difficulty-draf" class="form-select form-select-sm"
                ...
                <table id="selection-datatable-draf" class="table table-bordered dt-responsive nowrap w-100">
                    <thead>
                        <tr>
