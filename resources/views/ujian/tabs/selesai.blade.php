    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div id="custom-filters-selesai" class="mb-3">
                    <select id="filter-difficulty-selesai" class="form-select form-select-sm"
                ...
                <table id="selection-datatable-selesai" class="table table-bordered dt-responsive nowrap w-100">
                    <thead>
                        <tr>
