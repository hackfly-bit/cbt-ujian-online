    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <ul class="nav nav-tabs" id="tabKategori" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="draf-tab" data-bs-toggle="tab" data-bs-target="#draf"
                        type="button" role="tab">Draf</button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <!-- Tambah Soal Button -->
            <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambah-ujian">
        ...
        <div class="tab-content" id="tabKategoriContent">
            ...
            <div class="tab-pane fade" id="draf" role="tabpanel">
                @include('ujian.tabs.draf')
            </div>
        ...
        <div class="modal fade" id="tambah-ujian" tabindex="-1" role="dialog" aria-labelledby="scrollableModalTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="form-ujian" enctype="multipart/form-data">
                            @csrf
