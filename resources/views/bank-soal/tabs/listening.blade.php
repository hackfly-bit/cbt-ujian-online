        ...
        <div class="card">
            <div class="card-body">
                ...
                <div id="custom-filters-listening" class="mb-3">
                    <select id="filter-difficulty-listening" class="form-select form-select-sm"
                ...
                <table id="selection-datatable-listening" class="table table-bordered dt-responsive nowrap w-100">
                    <thead>
                        <tr>
